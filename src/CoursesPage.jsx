...
const CATEGORIES = [
    ...
    courses: [
      {
        ...
        link: "https://voujhg.courses.store/834932?utm_source=other&utm_medium=tutor-course-referral&utm_campaign=course-overview-webapp",
      ...
      },
      {
        ...
        link: "https://voujhg.courses.store/834931?utm_source=other&utm_medium=tutor-course-referral&utm_campaign=course-overview-webapp",
  ...
  },
  {
    ...
    courses: [
      {
        id: 401, tag: "GATE CS · SUBJECT", title: "Theory of Computation (TOC)",
        subtitle: "Prof Ravindrababu Ravula",
        ...
        description: "A focused, exam-oriented course covering the complete Theory of Computation syllabus for GATE CS — from Regular Languages and Finite Automata to Turing Machines and Undecidability.",
        highlights: ["Complete TOC Syllabus", "GATE CS Focused", "PYQ Coverage", "Concept Clarity"],
        price: "3,999", originalPrice: "6,999", discount: "43", color: "dark",
        details: {
          overview: "Theory of Computation is one of the most conceptually important and frequently tested subjects in GATE CS. This course is designed to build strong foundations and exam-ready understanding of all TOC topics — from the fundamentals of formal languages and automata theory to the advanced topics of Turing Machines and Undecidability.\n\nThe course follows the exact GATE CS syllabus and is structured to develop both conceptual clarity and problem-solving ability, with emphasis on Previous Year Questions and exam-level practice.",
          ...
          features: [
            ...
            "Compact and focused — no unnecessary detours",
          ],
          whatYouGet: [
            "Complete TOC lecture series (concept to exam-level)",
            "Previous Year Questions with detailed solutions",
            "Practice problems topic-wise",
            "Revision-friendly structured content",
          ],
          whoIsFor: [
      ...
      {
        id: 402, tag: "GATE CS · SUBJECT", title: "Database Management Systems (DBMS)",
        subtitle: "Prof Ravindrababu Ravula",
        ...
        description: "A focused, exam-oriented course covering the complete DBMS syllabus for GATE CS — from ER Model and Relational Algebra to Normalization, Transactions, and Indexing.",
        highlights: ["Complete DBMS Syllabus", "GATE CS Focused", "PYQ Coverage", "SQL & Normalization"],
        price: "3,999", originalPrice: "6,999", discount: "43", color: "dark",
        details: {
          overview: "Database Management Systems is a high-weightage subject in GATE CS and requires strong conceptual clarity combined with consistent problem-solving practice. This course covers the entire GATE CS DBMS syllabus in a structured and exam-focused manner — from the fundamentals of the ER Model and Relational Algebra to the advanced topics of Normalization, Transactions, Concurrency Control, and Indexing.\n\nEvery topic is explained with clarity, connected to previous year questions, and reinforced with exam-level problems to ensure you are exam-ready.",
          ...
          whatYouLearn: [
            ...
            "Transactions — ACID properties, serializability, conflict equivalence",
            "Concurrency Control — locking protocols, 2PL, timestamp ordering",
          ],
          subjects: [
            "ER Model & Relational Model",
          ...
          features: [
            ...
            "PYQ Discussion — all important previous year questions explained with approach",
            "Exam-Oriented Practice — questions at GATE difficulty level",
            "SQL and Normalization given special emphasis",
          ],
          whatYouGet: [
            "Complete DBMS lecture series (concept to exam-level)",
            "Previous Year Questions with detailed solutions",
            "Practice problems topic-wise",
            "Revision-friendly structured content",
          ],
          ...
          outcome: [
            "Strong conceptual understanding of all DBMS topics",
            "Ability to solve GATE-level DBMS questions confidently",
            "Clear command over SQL, Normalization, and Transactions",
            "Familiarity with indexing structures and concurrency protocols",
          ],
        },
      },
    ],
